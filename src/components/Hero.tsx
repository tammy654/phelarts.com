  ...
  return (
    <section id="home" className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-6 transform -translate-y-1/2 z-20">
        <button
          onClick={prevVideo}
          className="w-12 h-36 bg-transparent border border-[#fefefe]/0  flex items-center justify-center hover:bg-[#fefefe]/5 backdrop-blur-4xl transition-all duration-300"
        >
