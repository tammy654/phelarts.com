  ...
  return (
    <section id="home" className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-8 transform -translate-y-1/2 z-20">
        <button
          onClick={prevVideo}
          className="w-12 h-54 bg-[#fefefe]/3 backdrop-blur-xl border border-[#fefefe]/5  flex items-center justify-center hover:bg-[#fefefe]/10 transition-all duration-300"
        >
